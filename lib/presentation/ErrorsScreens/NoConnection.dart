    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          SizedBox(height: 8,),
          Text(S.of(context).no_connection_desc,style: TextStyle(color: Color(0xff999999),fontSize: 16),),
          SizedBox(height: 36,),
          Padding(
      ...
      child: Center(
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: 6,),
            Text(S.of(context).retry,style: Textstyles.medium20.copyWith(color: Colors.white),)
          ],
        ),
      ),
    );
