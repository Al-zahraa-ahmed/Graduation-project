            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child:  Text("Submit",style: Textstyles.medium20.copyWith(color: Colors.white),),
                ),
                const SizedBox(height: 10),
                TextButton(
                  onPressed: () {
        ...
        children: [
          ...
          Container(
            ...
            child: Stack(
              ...
              [
               QuistionCard(),
               Positioned(left: 10,child: Arrowbackandnext(icon: Icon(Icons.chevron_left),onpressed:previousQuestion ,)),
               Positioned(right: 10,child: Align(alignment: AlignmentGeometry.centerRight,child: Arrowbackandnext(icon: Icon(Icons.chevron_right),onpressed: nextQuestion,))),
              
              ]
               ),
               Align(alignment: Alignment.topCenter,child: CircularNumberProgress(number: currentQuestion,progress: currentQuestion/totalQuestions,))
